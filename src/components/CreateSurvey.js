    ...
    <div className=" w-full h-full flex flex-row flex-wrap justify-center items-center overflow-y-auto">
      <div className="cards border-brandBrown survey-basics w-72 h-85 m-2 flex flex-col">
        <form action="#" onSubmit={handleSubmit} className="flex flex-col">
          <label
            className="text-xl pl-4 pt-2 font-medium"
            htmlFor="surveyTitle"
          >
            Survey Title
          </label>
          <textarea
            ...
            name="surveyTitle"
          />
          <label className="text-xl pl-4 pt-2 font-medium" htmlFor="surveyType">
            Survey Type
          </label>
          ...
          <div className=" m-1 flex flex-row justify-around items-center">
            <label
              ...
              className="text-xl mr-2  font-medium w-40"
            >
              Survey Duration
            </label>
            <input
          ...
          <div className="flex flex-col justify-start items-start">
            <label
              className="text-xl pl-3 pt-2 ml-1 mt-2 font-medium"
            ...
            <div className="w-64 ml-4 flex justify-end items-center">
              <button
                ...
                type="submit"
                className="button bg-brandBrown text-khaki font-bold rounded-2xl h-6 w-20 flex justify-center items-center text-center text-md p-2 mb-2"
              >
                Submit
              </button>
            </div>
      ...
      <div className="cards survey-questions w-134  h-82 m-2  flex-col justify-evenly relative">
        <div className="font-medium text-brandBrown text-2xl">Questions</div>
        <DragDropContext onDragEnd={handleOnDragEnd}>
          <Droppable droppableId="questions">
            {(provided) => (
              <div
                className="overflow-y-auto questions w-full h-72"
                    ...
                    >
                      {(provided) => (
                        <div
                          ...
                          ref={provided.innerRef}
                          className="cards border-khaki border-l-8 border-t-2 question w-133 h-auto my-4 relative flex-col"
                        >
                          <div
                          ...
                          <div className="flex flex-row justify-evenly items-center">
                            ...
                            <select
                              ...
                              id="questionType"
                            >
                              <option value="text">Question Type</option>
                            ...
                            <button
                              ...
                              className="button bg-brandBrown absolute right-0 bottom-0 text-khaki font-bold rounded-2xl h-5 w-28 flex justify-center items-center text-center text-xs p-2 m-1"
                            >
                              Add Question
                            </button>
                          </div>
